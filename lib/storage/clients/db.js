...
function registerModel(modelName, dbCollectionName, schema) {
  modelClasses = modelClasses || {};
  modelClasses[modelName] = connection.model(dbCollectionName, schema);
}
...
function connect() {
  ...
  connection = mongoose.createConnection(uri, { server: { auto_reconnect: true } });
...
export { connect, getModelClass, removeModelClasses, registerModel };
